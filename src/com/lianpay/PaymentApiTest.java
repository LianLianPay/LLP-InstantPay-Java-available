...
public class PaymentApiTest {
	...
	public static void main(String[] args) throws Exception {
		...
		paymentRequestBean.setNo_order("483070737172");
		paymentRequestBean.setDt_order("20181129171750");
		paymentRequestBean.setMoney_order("1");
		paymentRequestBean.setCard_no("6222021302021997274");
		paymentRequestBean.setAcct_name("王磊");
		...
		// 填写商户自己的接收付款结果回调异步通知
		paymentRequestBean.setNotify_url("http://106.14.165.16/home/verify/daifu.html");
		...
		paymentRequestBean.setSign("RiORXuoXmhZjZWtN4K9Rb4JETkdtIKrfOoph5XTjf/2Mt1m0MvGWbp7DKCguD5I2PMerZ3fN1drFdjM4TSlj02I0eKi0C9BtmopUNUUZgcaW1vm80OgtOi8LEgduTCSKqERa4iJRQzbKmjSoypQvxE8AnrR6JtsKO/o6aPF+0hQ=");
